...
class Gate_Data:
    ...
    def find_max_delay(self):
        ...
        return max_delay,max_gate
    
    def find_max_gate_delay(self,gate_index,path_trav = {}):
        ...
        for input_gate_index in self.gate_dag_to[gate_index]:
            ...
            max_wg = max((wg for wg in self.wire_groups_between[(input_gate_index,gate_index)]), key = len)
    ...
    def init_wire_groups(self):        
        for gate_index,pin_index in self.wire_dag_from_to:                    
            ...
            for g_ind_to in pin_ref.connected_pins_to:
                if(g_ind_to == gate_index):
                    continue
                self.wire_groups_between[(gate_index,g_ind_to)].append(self.wire_groups[(gate_index,pin_index)])
